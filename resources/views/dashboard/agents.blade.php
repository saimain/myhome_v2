                            ...
                            <div class="modal-dialog  modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <hr>
                                        <p><b>Agent Infos</b></p>
                                        <img src="{{ asset('/storage/agent_profile/' . $data->agent_profile) }}" alt=""
                                            class="card-img mb-3">
                                        <p>Name : {{ $data->agent_name }}</p>
                                        <p>Contact Phone : {{ $data->agent_phone }}</p>
                                        <p>Type : {{ $data->agent_type }}</p>
                                        <p>Address : {{ $data->agent_address }}</p>
                                        <p>About : {{ $data->agent_about }}</p>
                                        <hr>
